 ...
 */
package com.techbridge.androidloaders;
  ...
  @Nullable @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    switch (pageNum) {
      ...
      case 5:
        ...
        break;
      case 6:
        rootView = inflater.inflate(R.layout.fragment_fillable_loader_seventh_page, container, false);
        break;
      case 7:
        rootView = inflater.inflate(R.layout.fragment_fillable_loader_eighth_page, container, false);
        break;
      default:
        rootView = inflater.inflate(R.layout.fragment_fillable_loader_seventh_page, container, false);
        break;
  ...
  private void setupFillableLoader(int pageNum) {
    if (pageNum == 3) {
      ...
      fillableLoader = loaderBuilder.parentView((FrameLayout) rootView)
          .svgPath(Paths.JOB_AND_TALENT)
          .layoutParams(params)
          .percentage(mPercentage).originalDimensions(970,970)
          .strokeColor(Color.parseColor("#1c9ade"))
          .fillColor(Color.parseColor("#1c9ade"))
      ...
      fillableLoader.setSvgPath(pageNum == 0 ? Paths.TANK : pageNum == 1 ? Paths.RONALDO
