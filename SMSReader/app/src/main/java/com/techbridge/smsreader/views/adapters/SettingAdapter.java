...
import com.techbridge.smsreader.views.activities.EditsettingActivity;
import java.util.ArrayList;
import java.util.HashMap;

public class SettingAdapter extends Adapter<SettingAdapter.ViewHolder> {
    ...
    public SettingAdapter(ArrayList<Setting> mySettings, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (this.itemsPendingRemoval.contains(data)) {
            ...
            holder.txtUndo.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    SettingAdapter.this.undoOpt(data);
                }
            });
            return;
        }
        ...
        holder.cardView.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Prefs.writeString(holder.cardView.getContext(), "sId", ((Setting) SettingAdapter.this.mSettings.get(position)).getSettingId());
                holder.cardView.getContext().startActivity(new Intent(holder.cardView.getContext(), EditsettingActivity.class));
            }
        });
    }
    ...
    public void pendingRemoval(int position) {
        ...
        if (!this.itemsPendingRemoval.contains(data)) {
            ...
            Runnable pendingRemovalRunnable = new Runnable() {
                public void run() {
                    SettingAdapter.this.remove(SettingAdapter.this.mSettings.indexOf(data));
                    SettingAdapter.this.dbHelper.deleteSetting(data.getSettingId());
                }
            };
