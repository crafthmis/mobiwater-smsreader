...
import com.techbridge.smsreader.utils.DateTimeSorter;
...
public class AlarmActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb = new DBHelper(getApplicationContext());
        ...
        List<com.techbridge.smsreader.utils.Reminder> mTest = rb.getAllReminders();
